...
const AddCourse = () => {
  ...
  const addLecture = (sectionIndex) => {
    ...
    sectionVar.course[sectionIndex].lectures = [
      ...sectionVar.course[sectionIndex].lectures,
    ...
    let errorVar = error
    errorVar.course[sectionIndex].lectures = [
      ...errorVar.course[sectionIndex].lectures,
      { title: '', description: '', videoId: '' },
    ]
  ...
  const addSection = () => {
    ...
    sectionVar.course = [
      ...mainForm.course,
      { sectionTitle: '', lectures: [{ title: '', description: '', videoId: '' }] },
    ]
    setMainForm(sectionVar)
    ...
    if (allowSubmit === true) {
      try {
        if (currentRoute.includes('update')) {
          ...
          if (saveCourseData) {
            // To be handled based on response
  ...
  let validateFormInput = () => {
    ...
    if (
      !mainForm.courseLearning ||
      mainForm.courseLearning.length === 0 ||
      (mainForm.courseLearning.length === 1 && mainForm.courseLearning[0] === '')
    ) {
      ...
      courseVar.lectures.forEach((lectureVar, index) => {
        if (!lectureVar.videoId) {
          ...
          errorObject.course[courseIndex].lectures[index].videoId =
            'Video Not Uploaded Successfully!! Please Upload Video Again'
        } else {
          errorObject.course[courseIndex].lectures[index].videoId = ''
          count++
        }
  ...
  const returnLine = (index) => {
    if (index !== 0) {
      return <div className='sectionLine'></div>
    }
  }
        ...
        <div className='subHeaderAlign'>
          <div>
            <input
              ...
              name='courseTitle'
              placeholder='Course Title'></input>
          </div>
          <div>
        ...
        <div className='subHeaderAlign'>
          <div>
            <input
              ...
              name='courseOverView'
              placeholder='Course OverView'></input>
          </div>
          <div>
                ...
                return (
                  <div key={index}>
                    <input
                      ...
                      name='courseLearning'
                      placeholder='Course Learnings'></input>
                    <button
                      onClick={() => {
                        removePoint('courseLearning', index)
                      }}>
                      <RemoveIcon />
                    </button>
                ...
                return (
                  <div key={index}>
                    <input
                      ...
                      placeholder='PreRequisites'></input>
                    <button
                      onClick={() => {
                        removePoint('preRequisite', index)
                      }}>
                      <RemoveIcon />
                    </button>
            ...
            <div key={sectionIndex}>
              ...
              <div className='sectionTitle'>
                <input
                  ...
                  name='sectionTitle'
                  placeholder='Add Section Title'></input>
                      ...
                      <div className='lectures' key={index}>
                        <div>
                          <input
                            ...
                            name='title'
                            onChange={(event) => {
                              onFormInput(sectionIndex, index, event)
                            }}
                        ...
                        <div>
                          <button
                            onClick={() => {
                              removeLecture(sectionIndex, index)
                            }}>
                            <RemoveIcon />
                          </button>
      ...
      <div className='priceSection'>
        <div className='priceSec'>
          <input
            ...
            placeholder='Course Price'></input>
