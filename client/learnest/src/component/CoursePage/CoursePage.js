...
const CoursePage = () => {
    ...
    const getData = async () => {
        ...
        // Get Video URL
        /* Step 1: Get Token */
        const accessToken = await axios.get(environment.GET_CUSTOM_UPLOAD_TOKEN);
        ...
        <div>
                    ...
                    <div className="lessonColLeft">
                        {
                            courseData?.courseLearning?.map((lesson, indexL) => {
                                return(
                                    ...
                                    <div className="point">
                                        <div><CheckIcon /></div>
                                        <div className="lesson" key={indexL}>{lesson}</div>
                                    </div>           
                                );
                            })
                        }
                    ...
                    <div className="lessonColRight">
                    {
                            courseData?.courseLearning?.map((lesson, indexR) => {
                                return(
                                    ...
                                    <div className="point">
                                        <div><CheckIcon /></div>
                                        <div className="lesson" key={indexR}>{lesson}</div>
                                    </div>
                                );
                            })
                    }
                    ...
                    <div className="preReqColLeft">
                        {
                            courseData?.preRequisite?.map((preReq, indexL) => {
                                return(
                                    ...
                                    <div className="point">
                                        <div><CheckIcon /></div>
                                        <div className="preRequisite" key={indexL}>{preReq}</div>
                                    </div>
                                );
                            })
                        }
                    ...
                    <div className="preReqColRight">
                    {
                            courseData?.preRequisite?.map((preReq, indexR) => {
                                return(
                                    ...
                                    <div className="point">
                                        <div><CheckIcon /></div>
                                        <div className="preRequisite" key={indexR}>{preReq}</div>
                                    </div>
                                );
                            })
                    }
            ...
            <div className="content">
                ...
                <div className="accordianDiv">
                    {
                        courseData?.course?.map((section, sectionIndex) => {
                            return(
                                    <Accordion>
                                        <AccordionSummary
                                                    ...
                                                    return(
                                                        <Typography>
                                                            <Accordion>
                                                                ...
                                                                >
                                                                <Typography>
                                                                    <div className="linkToVideo" onClick={ () => { setPopupData(lecture?.videoId) } }>Popup Open</div>
